...
<br></br>
            ...
            <MDBRow>
                ...
                <MDBCol md='6' xs='10'>
                    <Card border="none" style={{backgroundColor:`${ui.backgroundColor}`, color:'white'}}>
                        <Card.Body>
                            <Card.Title className="fst-italic" style={{color:`${ui.borders}`}}><h3>WAREHOUSE SPACE</h3></Card.Title>
<br></br>
                            <Card.Text className="fs-5 lh-lg fw-light" >
...
<br></br>
            ...
            <MDBRow className='justify-content-center'>
                <MDBCol md='3' style={{color:'white', marginLeft:'20px'}}><p ><h1>OUR SERVICES</h1></p></MDBCol>
            </MDBRow>
            <MDBRow>
                <div className='d-flex justify-content-center' style={{color:`${ui.bigTitleSecondaryColor}`}}>
            ...
            <MDBRow>
                <MDBCol md='4' xs='10' >
                    <Card border="none" className='p-sm-3 p-1' style={{ backgroundColor: `${ui.borders}`, boxShadow: `3px 3px 5px ${ui.borders}`, color:'white' }}>
                        <Card.Body >
                            <Card.Title className="fst-italic" style={{color:`${ui.backgroundColor}`}}><h4>PROFESSIONAL APPROACH</h4></Card.Title>
                ...
                <MDBCol md='4' xs='10' >
                    <Card border="none" className='p-sm-3 p-1' style={{ backgroundColor: `${ui.borders}`, boxShadow: `3px 3px 5px ${ui.borders}`, color:'white' }}>
                        <Card.Body>
                            <Card.Title className="fst-italic" style={{color:`${ui.backgroundColor}`}}><h4>PERSONIFICATION</h4></Card.Title>
                ...
                <MDBCol md='4' xs='10' >
                    <Card border="none" className='p-sm-3 p-1' style={{ backgroundColor: `${ui.borders}`, boxShadow: `3px 3px 5px ${ui.borders}`, color:'white' }}>
                        <Card.Body>
                            <Card.Title className="fst-italic" style={{color:`${ui.backgroundColor}`}}><h4>SPEED</h4></Card.Title>
            ...
            <MDBRow>
                <MDBCol md='4' xs='10' >
                    <Card border="none" className='p-sm-3 p-1' style={{ backgroundColor: `${ui.borders}`, boxShadow: `3px 3px 5px ${ui.borders}`, color:'white' }}>
                        <Card.Body>
                            <Card.Title className="fst-italic" style={{color:`${ui.backgroundColor}`}}><h4>ALL LEBANON</h4></Card.Title>
                ...
                <MDBCol md='4' xs='10' >
                    <Card border="none" className='p-sm-3 p-1' style={{ backgroundColor: `${ui.borders}`, boxShadow: `3px 3px 5px ${ui.borders}`, color:'white' }}>
                        <Card.Body>
                            <Card.Title className="fst-italic" style={{color:`${ui.backgroundColor}`}}><h4>LEGAL SERVICE</h4></Card.Title>
                ...
                <MDBCol md='4' xs='10' >
                    <Card border="none" className='p-sm-3 p-1' style={{ backgroundColor: `${ui.borders}`, boxShadow: `3px 3px 5px ${ui.borders}`, color:'white' }}>
                        <Card.Body>
                            <Card.Title className="fst-italic" style={{color:`${ui.backgroundColor}`}}><h4>CONSULTATION SERVICES</h4></Card.Title>
